...
access_key=$(cat ${PWD}/assume-role-output.json | grep aws_access_key_id | awk '{print $3}')
secret_key=$(cat ${PWD}/assume-role-output.json | grep aws_secret_access_key | awk '{print $3}')
